...
(function() {
  ...
  Madeleine = function(options) {
    ...
    Madeleine.prototype.adaptViewerTheme = function() {
      ...
      switch (theme) {
        case "dark":
          this.options.objectColor = "2B2B2B" ;
          break;
        case "neutral":
          this.options.objectColor = "FDF5E6"; // [212, 255, 0];
          break;
        case "blue":
          this.options.objectColor = "1B3990"; // [201, 76, 102];
          break;
        case "purple":
          this.options.objectColor = "643388"; // [0, 160, 140];
          break;
        case "green":
          this.options.objectColor = "00A537"; // [82, 84, 203];
          break;
        case "red":
          
          this.options.objectColor = "D20028"; // [12, 107, 192];
          break;
        case "orange":
          
          this.options.objectColor = "F03B12";
          break;
        case "yellow":
          
          this.options.objectColor ="EAE300";
          break;
        default:
          this.__viewer.style.cssText += this.generateGradation({bright: "FFFFFF"});
          this.options.objectColor = "FDF5E6";
          break;
      }
